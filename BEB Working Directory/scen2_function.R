...
# Scenario 2: Natural Transition on Daily Miles
...
scen2_emissions_model <- function(assumed_bus_life = 14, 
  ...
  bus_data[bus_data$Final.Year <= 2022, "Final.Year"] <- 2022
  bus_data$Year.Start <- bus_data$Final.Year + 1
  bus_data[bus_data$Fuel.Type == "Electric Battery", "Year.Start"] <- 2023
