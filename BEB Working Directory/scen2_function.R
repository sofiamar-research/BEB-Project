...
# Scenario 2: Natural Transition

scen2_emissions_model <- function(assumed_bus_life = 14, 
  ...
  bus_data <- left_join(bus_mileage, egrid_zip[,c(2,4)], by = c("Zip.Code" = "ZIP..numeric."))
  # If a bus had a final year before 2023, they will start this scenario with a new BEB in 2023
  bus_data[bus_data$Final.Year <= 2021, "Final.Year"] <- 2021
  bus_data$Year.Start <- bus_data$Final.Year + 1
  bus_data[bus_data$Fuel.Type == "Electric Battery", "Year.Start"] <- 2021
