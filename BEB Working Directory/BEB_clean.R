...
reduction_plot <- CO2e_reduc/(CO_reduc + VOC_reduc)/(NOx_reduc + SOx_reduc)/(PM10_reduc + PM2.5_reduc)

reduction_plot

# ggsave(filename = "Graphs/reduction.png",
#        plot = reduction_plot,
#        dpi = 700,
#        width = 8,
#        height = 10.5,
...
lcod <- data.frame(Fuel.Type = c("Diesel", "Compressed Natural Gas", "Electric"),
                   ...
                   Maintenance.dollar..mi = c(0.94, 0.94, 0.66),
